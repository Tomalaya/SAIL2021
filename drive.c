...
void Drive()
{
	...
	float rs = (js.Magnitude * cos(degreesToRadians(120)-js.Direction)); //Right wheel aims at 120 degrees
	float ls = (js.Magnitude * cos(degreesToRadians(240)-js.Direction)); //Left aims at 240.
	float ts = (js.Magnitude * cos(/*degreesToRadians(0)*/-js.Direction)); //Tail wheel aims at 0
